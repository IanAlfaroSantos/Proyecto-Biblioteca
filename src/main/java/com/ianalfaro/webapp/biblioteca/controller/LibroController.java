...
import com.ianalfaro.webapp.biblioteca.service.LibroService;
...
public class LibroController {
    ...
    public ResponseEntity<Map<String, String>> agregarLibro(@RequestBody Libro libro) {
        ...
        try {
            ...
            response.put("message", "¡¡Libro agregado con éxito :D!!");
    ...
    public ResponseEntity<Map<String, String>> editarLibro(@RequestParam Long id, @RequestBody Libro libroNuevo){
        ...
        try {
            ...
            libroService.guardarLibro(libro);
            response.put("message", "Libro modificado con éxito :D");
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            response.put("message", "Error");
    ...
    public ResponseEntity<Map<String, String>> eliminarLibro(@RequestParam Long id){
        ...
        try {
            ...
            response.put("message", "El libro se ha eliminado con éxito :D");
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            response.put("message", "Error");
